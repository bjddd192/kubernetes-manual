...
# 禁止节点调度
kubectl cordon 10.250.11.178
# 驱逐节点 pod
kubectl drain 10.250.11.178 --ignore-daemonsets --delete-local-data
# 强制驱逐节点 pod
kubectl drain 10.250.11.178 --ignore-daemonsets --delete-local-data --force
...
# 恢复节点调度
kubectl uncordon 10.250.11.178
